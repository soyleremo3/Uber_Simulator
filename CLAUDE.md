...
| Rota/GPS çizgisi | `RouteManager` — sahnedeki `Waypoint` graph'ı üzerinde BFS, gerçek zemin-mesh ribbon (LineRenderer DEĞİL) | `_Scripts/_Core/RouteManager.cs`, `Waypoint.cs` |
